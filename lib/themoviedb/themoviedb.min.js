var theMovieDb={};theMovieDb.common={api_key:"YOUR_KEY",base_uri:"http://api.themoviedb.org/3/",images_uri:"http://image.tmdb.org/t/p/",
timeout:5000,generateQuery:function(b){var a,d,c;a=b||{};d="?api_key="+theMovieDb.common.api_key;if(Object.keys(a).length>0){for(c in a){if(a.hasOwnProperty(c)&&c!=="id"&&c!=="body"){d=d+"&"+c+"="+a[c]}}}
return d},validateCallbacks:function(a){if(typeof a[0]!=="function"||typeof a[1]!=="function"){throw"Success and error parameters must be functions!"}},
validateRequired:function(b,f,d,e,g){var c,a;a=g||false;if(b.length!==f){throw"The method requires  "+f+" arguments and you are sending "+b.length+"!"}if(a){return}if(f>2){for(c=0;c<e.length;c=c+1)
{if(!d.hasOwnProperty(e[c])){throw e[c]+" is a required parameter and is not present in the options!"}}}},getImage:function(a){return theMovieDb.common.images_uri+a.size+"/"+a.file},client:function(c,e,b)
{var f,a,d;f=c.method||"GET";a=c.status||200;d=new XMLHttpRequest();d.ontimeout=function(){b('{"status_code":408,"status_message":"Request timed out"}')};d.open(f,theMovieDb.common.base_uri+c.url,true);
if(c.method==="POST"){d.setRequestHeader("Content-Type","application/json");d.setRequestHeader("Accept","application/json")}d.timeout=theMovieDb.common.timeout;d.onload=function(g){if(d.readyState===4)
{if(d.status===a){e(d.responseText)}else{b(d.responseText)}}else{b(d.responseText)}};d.onerror=function(g){b(d.responseText)};if(c.method==="POST"){d.send(JSON.stringify(c.body))}
else{d.send(null)}}};theMovieDb.configurations={getConfiguration:function(b,a){theMovieDb.common.validateRequired(arguments,2);
theMovieDb.common.validateCallbacks([b,a]);theMovieDb.common.client({url:"configuration"+theMovieDb.common.generateQuery()},b,a)}};
theMovieDb.account={getInformation:function(b,c,a){theMovieDb.common.validateRequired(arguments,3,b,["session_id"]);
theMovieDb.common.validateCallbacks([c,a]);theMovieDb.common.client({url:"account"+theMovieDb.common.generateQuery(b)},c,a)},getLists:function(b,c,a){theMovieDb.common.validateRequired(arguments,3,b,["session_id","id"]);
theMovieDb.common.validateCallbacks([c,a]);theMovieDb.common.client({url:"account/"+b.id+"/lists"+theMovieDb.common.generateQuery(b)},c,a)},getFavoritesMovies:function(b,c,a)
{theMovieDb.common.validateRequired(arguments,3,b,["session_id","id"]);theMovieDb.common.validateCallbacks([c,a]);theMovieDb.common.client({url:"account/"+b.id+"/favorite_movies"+theMovieDb.common.generateQuery(b)},c,a)},
addFavorite:function(c,d,b){var a;theMovieDb.common.validateRequired(arguments,3,c,["session_id","id","movie_id","favorite"]);theMovieDb.common.validateCallbacks([d,b]);a={movie_id:c.movie_id,favorite:c.favorite};
theMovieDb.common.client({url:"account/"+c.id+"/favorite"+theMovieDb.common.generateQuery(c),status:201,method:"POST",body:a},d,b)},
getRatedMovies:function(b,c,a){theMovieDb.common.validateRequired(arguments,3,b,["session_id","id"]);theMovieDb.common.validateCallbacks([c,a]);
theMovieDb.common.client({url:"account/"+b.id+"/rated_movies"+theMovieDb.common.generateQuery(b)},c,a)},getWatchlist:function(b,c,a){theMovieDb.common.validateRequired(arguments,3,b,["session_id","id"]);
theMovieDb.common.validateCallbacks([c,a]);theMovieDb.common.client({url:"account/"+b.id+"/movie_watchlist"+theMovieDb.common.generateQuery(b)},c,a)},addMovieToWatchlist:function(c,d,b)
{var a;theMovieDb.common.validateRequired(arguments,3,c,["session_id","id","movie_id","movie_watchlist"]);
